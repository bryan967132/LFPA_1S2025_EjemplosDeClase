...
public class ParserTest {
    public static void main(String ... args) {
        String input = readInput("./Inputs/Entrada1.lfp");
        ...
        ArrayList<World> worlds = parser.parser();
        
        System.out.println("-\n");
        System.out.println("\u001B[32mProyecto2$\u001B[0m");
        System.out.println(Outs.getStringOuts());

        for(World world : worlds) {
            Classes.Utils.Graphs.exportGraph(world);
        }
    }
